...
alias ls='eza'
alias lsd='eza --long --header --git --only-dirs'
alias lss='eza --long --header --git --sort size'
alias lsn='eza --long --header --git --sort name'
alias lsm='eza --long --header --git --sort mod'
alias lse='eza --long --header --git --sort ext'
